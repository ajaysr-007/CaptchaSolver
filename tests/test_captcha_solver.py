...
from captcha_solver import CaptchaSolver, binarise, load_and_normalise, remove_noise_blobs, segment_characters
...
def test_solver_prefers_longer_text(monkeypatch):
    ...
    monkeypatch.setattr(solver_module, "binarise", lambda gray, method="adaptive": np.zeros_like(gray))
